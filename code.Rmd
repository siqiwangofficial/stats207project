...
## add regressor
m = add_regressor(m, 'DEWP') 
m = add_regressor(m, 'TEMP') 
m = add_regressor(m, 'PRES') 
m = add_regressor(m, 'Iws') 
##
...
# Plot the forecast
plot(m, long_forecast)
long_forecast = long_forecast[1461:1826, 'yhat']
```
...
# Plot the forecast
plot(m, short_future)
short_future = short_future[1461:1467, 'yhat']
```
